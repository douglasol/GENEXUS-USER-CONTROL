...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="RenderBootstrapButton">
	...
	<h2 style='background:#5d4384;color:5d4384;padding:5px; font-size: 30px; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;'>Bootstrap</h2>
	<p style='color:#5d4384;padding:5px; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;font-size: 20px;'>Button</p>
	</div>		
    </span>
  </xsl:template>
