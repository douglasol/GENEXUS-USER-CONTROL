  ...
  <xsl:template name="RenderLabel">
    <span atomicselection="true">
      <xsl:call-template name="AddStyleAttribute"/>
			...
			<h2 style='background:#5d4384;color:5d4384;padding:5px; font-size: 30px; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;'>Livro UC</h2>
			<p style='color:#5d4384;padding:5px; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;font-size: 20px;'>Label</p>
			</div>
